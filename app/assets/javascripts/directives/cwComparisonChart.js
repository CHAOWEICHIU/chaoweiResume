...
myApp.directive('cwComparisonChart', ['$window',function ($window) {
	function link(scope, iElement, iAttrs) {
		...
		var newFirms = firms.reduce(function(firms, firmArray){
			...
			firmArray.totalROS = firms.reduce(function(p,c){return p + c.ROS}, 0);
			firmArray.totalROA = firms.reduce(function(p,c){return p + c.ROA}, 0);
			firmArray.totalROE = firms.reduce(function(p,c){return p + c.ROE}, 0);
